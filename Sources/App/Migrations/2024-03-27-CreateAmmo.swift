    ...
    struct CreateAmmo: AsyncMigration {
        func prepare(on database: any Database) async throws {
            try await database.schema(for: BattleTech.Ammo.self)
                ...
                .field(BattleTech.Ammo.V20240327.techBase, .uuid, .required,
                ...
                .field(BattleTech.Ammo.V20240327.techLevelStatic, .uuid, .required,
                ...
                .field(BattleTech.Ammo.V20240327.munitionType, .uuid, .required,
